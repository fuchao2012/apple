if (typeof document !== "undefined" && !("classList" in document.createElement("a"))) {
    (function (k) {
        ...
        var a = "classList",
            g = "prototype",
            n = (k.HTMLElement || k.Element)[g],
            b = Object,
            l = String[g].trim || function () {
        ...
        f.toggle = function (q, r) {
            q += "";
            var p = this.contains(q),
                s = p ? r !== true && "remove" : r !== false && "add";
            if (s) {
                this[s](q)
            }
            return !p
    ...
    ! function () {
        ...
        g = function (j, d, k) {
            ...
            function v(j) {
                ...
                for (var x = j.split("/"), n = w.split("/").slice(0, -1), m = 0, l = x.length; l > m; m++) {
                    var k = x[m];
                    if (".." === k) {
                        n.pop()
                    } else {
        ...
        var p, o = "undefined" != typeof window ? window : {},
        ...
        function Y(k, j, o, n) {
            var m = k._subscribers,
                l = m.length;
            m[l] = j, m[l + N] = o, m[l + L] = n
        }

        function X(k, j) {
            for (var p, o, n = k._subscribers, m = k._detail, l = 0; l < n.length; l += 3) {
        ...
        var M = aj.config,
            K = (aj.configure, ai.objectOrFunction),
            J = ai.isFunction,
            I = (ai.now, ah.all),
            H = ag.race,
            G = af.resolve,
...
! function (f) {
    ...
    function h(j, m) {
        ...
        if (j && "." === j.charAt(0)) {
            if (m) {
                for (l.pop(), j = j.split("/"), j = l.concat(j), k = 0; k < j.length; k += 1) {
                    if ("." === j[k]) {
                        j.splice(k, 1), k -= 1
                    } else {
                        if (".." === j[k]) {
                ...
                __matchName: function (k) {
                    ...
                    for (j = this.__model.length - 1; j >= 0; j--) {
                        if (Array.isArray(this.__model[j])) {
                            for (l = this.__model[j].length - 1; l >= 0; l--) {
    ...
    40: [
        function (c, f, b) {
            ...
            d.prototype = {
                ...
                properties: function () {
                    var i = (typeof this._parent === "undefined" || this._parent === null) ? {} : this._parent.properties();
